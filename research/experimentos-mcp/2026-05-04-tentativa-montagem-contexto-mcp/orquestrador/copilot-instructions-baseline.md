...
## Restrições do cenário (baseline)

- Não usar MCP.
- Não usar `.github/instructions` ou qualquer outro corpus externo.
- Se não houver evidência no código, rotule como **HIPÓTESE** e descreva como validar; não transforme hipótese em “padrão organizacional”.
